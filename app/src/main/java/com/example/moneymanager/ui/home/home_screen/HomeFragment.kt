...
import com.example.moneymanager.ui.home.home_screen.fragment.AccountSelectorBottomSheet
...
class HomeFragment : Fragment() {
    ...
    private var accounts: MutableList<AccountWithWallet> = mutableListOf()
    private var currentAccount: AccountWithWallet? = null
    ...
    private fun openAccountSelector(
        accounts: List<AccountWithWallet>,
        currentAccount: AccountWithWallet
    ) {
